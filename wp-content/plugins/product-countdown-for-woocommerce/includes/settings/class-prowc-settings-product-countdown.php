...
class ProWC_Settings_Product_Countdown extends WC_Settings_Page {
	...
	function __construct() {
		...
		$this->label = __( 'Product Time Countdown', PCFWC_TEXTDOMAIN );
		parent::__construct();
	...
	function get_settings() {
		...
		return array_merge( apply_filters( 'woocommerce_get_settings_' . $this->id . '_' . $current_section, array() ), array(
			array(
				'title'     => __( 'Reset Settings', PCFWC_TEXTDOMAIN ),
				'type'      => 'title',
				'id'        => $this->id . '_' . $current_section . '_reset_options',
			),
			array(
				'title'     => __( 'Reset section settings', PCFWC_TEXTDOMAIN ),
				'desc_tip'  => __( 'Check this box and save changes to reset section settings.', PCFWC_TEXTDOMAIN ),
				'desc'      => '<strong>' . __( 'Reset', PCFWC_TEXTDOMAIN ) . '</strong>',
	...
	function admin_notice_settings_reset() {
		echo '<div class="notice notice-warning is-dismissible"><p><strong>' .
			__( 'Your settings have been reset.', PCFWC_TEXTDOMAIN ) . '</strong></p></div>';
	}
